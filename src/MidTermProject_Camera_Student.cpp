...
int main(int argc, const char *argv[])
{
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        */
        ...
        {
            detKeypointsShiTomasi(keypoints, imgGray, show);
        }
        else if (detectorType.compare("HARRIS") == 0)
        {
            detKeypointsHarris(keypoints, imgGray, show);
        } else {
            detKeypointsModern(keypoints, imgGray, detectorType, show);
        }
        //// EOF STUDENT ASSIGNMENT
        ...
        if (bFocusOnVehicle)
        {
            ...
            std::cout << "keypoint count before vehicle filtering: " << keypoints.size() << std::endl;
            keypoints = filtered;
            std::cout << "keypoint count after vehicle filtering: " << keypoints.size() << std::endl;
        }
